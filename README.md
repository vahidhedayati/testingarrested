...
Finally whilst writing the plugin, I have found myself repeating the create-app etc commands over and over again, to test a basic version of this grails command line is sufficient enough. So if you have access to bash via Linux/Mac check out [automated app creation](https://github.com/vahidhedayati/testingarrested/wiki/automated---app-creator---bash-script)
