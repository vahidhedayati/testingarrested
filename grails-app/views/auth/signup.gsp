                ...
                <div class="panel-body">
                    ...
                    <form name="signUpForm1"  class="form form-signup" role="form" novalidate>
 							 ...
 							 <div class="form-group">
                            	<div  class="control-group" ng-class="{'has-error': signUpForm1.username.$invalid && signUpForm1.username.$dirty}" >
                            	 <div class="input-group">
                               	 	<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                                	<input type="text" name="username" data-ng-model="user.username" class="form-control" ng-minlength="4" ng-maxlength="40" placeholder="${message(code: 'security.username.label', default: 'Username')}" />
	                        ...
	                        <div class="form-group">
	                        <div  class="control-group" ng-class="{'has-error': signUpForm1.passwordHash.$invalid && signUpForm1.passwordHash.$dirty}" >
                            <div class="input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                                <input type="text" name="preventAutoPass" id="preventAutoPass" style="display:none" />
                                <input type="password" name="password" data-ng-model="user.passwordHash"   ng-pattern="/^.*(?=.{8,})(?=.*[a-z])(?=.*[A-Z])(?=.*[\d\W]).*$/"  ng-maxlength="10" class="form-control" ng-minlength="1" placeholder="${message(code: 'security.password.label', default: 'Password')}" autocomplete="off"/>
								<span ng-show="!signUpForm1.password.$pristine && signUpForm1.username.$invalid" class="help-block"><g:message code="default.invalid.label" args="['password']" default="Invalid password"/></span>
                          	...
                          	<div class="form-group">
                          	<div  class="control-group" ng-class="{'has-error': signUpForm1.passwordConfirm.$invalid && signUpForm1.passwordConfirm.$dirty && signUpForm1.passwordHash.$dirty }" >
                            <div class="input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                                <input type="text" name="preventAutoPass" id="preventAutoPass" style="display:none" />
                                <input type="password" name="passwordConfirm" data-ng-model="user.passwordConfirm"   password-match="user.passwordHash" class="form-control"  ng-maxlength="10" placeholder="${message(code: 'security.password.confirm.label', default: 'Confirm Password')}" autocomplete="off"/>
								<span ng-show="!signUpForm1.passwordConfirm.$pristine && signUpForm1.username.$invalid" class="help-block"><g:message code="default.invalid.label" args="['passwordConfirm']" default="Invalid passwordConfirm"/></span>
								...
								<span ng-show="signUpForm1.passwordConfirm.$error.unique && signUpForm1.passwordConfirm.$dirty" class="help-inline"><g:message code="default.password.unique.label" args="['password']" default="PasswordConfirm does not match Password"/></span>
                            </div>
                        	</div>
                        	</div>
