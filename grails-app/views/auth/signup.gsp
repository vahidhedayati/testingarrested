                    ...
                    <div class="form-group">
                     <div class="input-group">
                        ...
                        <input type="password" name="passwordConfirm" data-ng-model="user.passwordConfirm"   password-match="user.passwordHash" class="form-control"  ng-maxlength="10" placeholder="${message(code: 'security.password.confirm.label', default: 'Confirm Password')}" autocomplete="off" required="required"/>
                         <div class="error" ng-show="signUpForm1.passwordConfirm.$dirty && signUpForm1.passwordConfirm.$invalid && signUpForm1.password.$invalid">
                        	<small class="error" ng-show="!signUpForm1.passwordConfirm.$pristine && signUpForm1.username.$invalid"><g:message code="default.invalid.label" args="['passwordConfirm']" default="Invalid passwordConfirm"/></small>
							<small class="error" ng-show="signUpForm1.passwordConfirm.$error.maxlength" ><g:message code="default.maxlength.label" args="['passwordConfirm']" default="Password too long"/></small>
							<small class="error" ng-show="signUpForm1.passwordConfirm.$error.unique && signUpForm1.passwordConfirm.$dirty" ><g:message code="default.password.unique.label" args="['password']" default="PasswordConfirm does not match Password"/></small>	
						</div>
                   </div>
                   </div>
